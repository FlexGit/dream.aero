	...
	<div class="main-block-full str">
		<div class="video">
			<video poster="{{ asset('img/mainpic.webp') }}" preload="auto" muted playsinline autoplay="autoplay" loop="loop">
				<source src="{{ asset('video/mainvideo.mp4?v=1') }}" type="video/mp4">
				<source src="{{ asset('video/mainvideo.webm?v=1') }}" type="video/webm">
				<source src="{{ asset('video/mainvideo.ogv?v=1') }}" type="video/ogv">
...
@push('scripts')
	...
	<script src="{{ asset('js/mainonly.js?v=14') }}"></script>
