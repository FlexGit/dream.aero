							...
							<tr>
								...
								<td colspan="3" rowspan="3" bgcolor="#FFFFFF" style="padding:10px 0 30px;text-align:center">
									...
									<p style="margin:15px 30px 33px;text-align:left;font-size:14px;line-height:30px;color:#484a42;">
										Payment amount {{ $bill->amount }} USD.<br>
										@if($bill->uuid)
											<a href="https://dream-aero.ru/payment/{{ $bill->uuid }}" target="_blank">Link for payment</a> (<a href="https://dream-aero.ru/payment/{{ $bill->uuid }}" target="_blank">https://dream-aero.ru/payment/{{ $bill->uuid }}</a>)
										@endif
									</p>
