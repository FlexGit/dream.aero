...
<tr class="odd">
	<td>
		<a href="javascript:void(0)" data-toggle="modal" data-url="/user/{{ $user->id }}/show" data-title="Show" title="Show">{{ $user->fio() }}</a>
	</td>
	...
	<td class="text-center d-none d-xl-table-cell">{{ $user->enable ? 'Yes' : 'No' }}</td>
	<td class="text-center align-middle">
		...
		{{--<a href="javascript:void(0)" data-toggle="modal" data-target="#modal" data-url="/user/{{ $user->id }}/delete" data-action="/user/{{ $user->id }}" data-method="DELETE" data-title="Delete">
