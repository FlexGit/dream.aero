...
@section('content')
	...
	<div class="about simul" id="about">
		...
		<div class="image wow fadeInLeft" data-wow-delay="1s" data-wow-duration="2s" style="visibility: visible; animation-duration: 2s; animation-delay: 1s; animation-name: fadeInLeft;">
			<iframe width="100%" src="{{ asset('img/' . Session::get('domain') . '/aerofobia.jpg') }}" frameborder="0" scrolling="no" allowfullscreen></iframe>
		</div>
	</div>
			...
			<div class="article-content">
				<div class="row">
					<div class="col-md-12 about-simulator">
						...
						<a href="{{ url('#popup-offer-2') }}" class="popup-with-form offer" style="background-image: url({{ asset('img/' . Session::get('domain') . '/Blok_2.png') }});background-position: top; background-size: cover;" data-popup-type="info" data-alias="offer-6">
						...
						<a href="{{ url('#popup-offer-3') }}" class="popup-with-form offer" style="background-image: url({{ asset('img/' . Session::get('domain') . '/Blok_3.png') }});background-position: top; background-size: cover;" data-popup-type="info" data-alias="offer-7">
						...
						<a href="{{ url('#popup-offer-4') }}" class="popup-with-form offer" style="background-image: url({{ asset('img/' . Session::get('domain') . '/Blok_4.png') }});background-position: top; background-size: cover;" data-popup-type="info" data-alias="offer-8">
	...
	<style>
		...
		@media screen and (max-width: 1500px) {
			...
			.offer {
				...
				min-height: 320px;
				vertical-align: top;
				background: url({{ asset('img/' . Session::get('domain') . '/dots.png') }}) no-repeat 60px 35px;
			}
		}
