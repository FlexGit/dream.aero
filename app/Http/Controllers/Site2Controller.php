...
class Site2Controller extends Controller
{
	...
	public function getCertificateModal()
	{
		...
		$VIEW = view($this->site . '.modal.certificate', [
			'city' => $city,
	...
	public function giftFlight()
	{
		...
		return view($this->site . '.gift-flight', [
			'page' => $page ?? new Content,
			'promobox' => $promobox,
			'city' => $city,
			'cityAlias' => $cityAlias,
	...
	public function flightTypes()
	{
		...
		return view($this->site . '.flight-types', [
			'page' => $page ?? new Content,
			'promobox' => $promobox,
			'city' => $city,
			'cityAlias' => $cityAlias,
	...
	public function contacts($cityAlias = null)
	{
		...
		return view($this->site . '.contacts', [
			'locations' => $locations,
			'page' => $page ?? new Content,
			'promobox' => $promobox,
			'city' => $city,
	...
	public function privateEvents()
	{
		...
		return view($this->site . '.private-events', [
			'city' => $city,
			'cityAlias' => $cityAlias,
			'page' => $page ?? new Content,
			'promobox' => $promobox,
	...
	public function flightBriefing()
	{
		...
		return view($this->site . '.flight-briefing', [
			'city' => $city,
			'cityAlias' => $cityAlias,
			'page' => $page ?? new Content,
			'promobox' => $promobox,
	...
	public function impressions()
	{
		...
		return view($this->site . '.impressions', [
			'city' => $city,
			'cityAlias' => $cityAlias,
			'page' => $page ?? new Content,
			'promobox' => $promobox,
	...
	public function profAssistance()
	{
		...
		return view($this->site . '.prof-assistance', [
			'city' => $city,
			'cityAlias' => $cityAlias,
			'page' => $page ?? new Content,
			'promobox' => $promobox,
	...
	public function worldAviation()
	{
		...
		return view($this->site . '.world-of-aviation', [
			'city' => $city,
			'cityAlias' => $cityAlias,
			'page' => $page ?? new Content,
			'promobox' => $promobox,
	...
	public function flyNoFear()
	{
		...
		return view($this->site . '.treating-aerophobia', [
			'city' => $city,
			'cityAlias' => $cityAlias,
			'page' => $page ?? new Content,
			'promobox' => $promobox,
	...
	public function getSchemeModal($locationId)
	{
		...
		$VIEW = view($this->site . '.modal.scheme', [
			'location' => $location,
		]);
	...
	{
		$VIEW = view($this->site . '.modal.info', [
			'alias' => $alias,
		]);
	...
	public function getNews($alias, $newsAlias = null)
	{
		...
		if ($newsAlias) {
			...
			return view($this->site . '.news-detail', [
				'news' => $news,
				'city' => $city,
				'cityAlias' => $cityAlias,
				'promobox' => $promobox,
		...
		return view($this->site . '.news-list', [
			'news' => $news ?? [],
			'city' => $city,
			'cityAlias' => $cityAlias,
			'page' => $page ?? new Content,
	...
	public function getPromos($alias = null)
	{
		...
		if ($alias) {
			...
			return view($this->site . '.promos-detail', [
				'promo' => $promo,
				'city' => $city,
				'cityAlias' => $cityAlias,
				'promobox' => $promobox,
			...
			return view($this->site . '.promos-list', [
				'promos' => $promos,
				'city' => $city,
				'cityAlias' => $cityAlias,
				'page' => $page ?? new Content,
	...
	public function getReviews()
	{
		...
		return view($this->site . '.reviews-list', [
			'reviews' => $reviews ?? [],
			'city' => $city,
			'cityAlias' => $cityAlias,
			'page' => $page ?? new Content,
	...
	public function getCallbackModal()
	{
		...
		$VIEW = view($this->site . '.modal.callback');
	...
	public function getReviewModal()
	{
		...
		$VIEW = view($this->site . '.modal.review');
	...
	public function privacyPolicy()
	{
		...
		return view($this->site . '.privacy-policy', [
			'city' => $city,
			'cityAlias' => $cityAlias,
			'page' => $page ?? new Content,
			'promobox' => $promobox,
